...
import com.ascentya.AsgriV2.Utils.AddCrops_Dialog;
...
public class Farmx_Addland extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_scheme.setOnClickListener(new DebouncedOnClickListener(1500) {
            ...
            public void onDebouncedClick(View v) {
                ...
                if (scheme_name.getText().toString().length() > 0) {
                    ...
                    Toast.makeText(Farmx_Addland.this, "Write something to post", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        viewDialog = new ViewDialog(Farmx_Addland.this);
        ...
        district.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toasty.normal(Farmx_Addland.this, block_data.get(i).getId()).show();
        ...
        intercrop.setOnClickListener(new DebouncedOnClickListener(1500) {
            ...
            public void onDebouncedClick(View v) {
                ...
                obj.dialog(Farmx_Addland.this, Main_Crop_list, Inter_Crop_List, Webservice.Data_crops, "Select crops", humidity.getText().toString(), water_ph.getText().toString(), temperature.getText().toString(), pollution.getText().toString(), moisture.getText().toString(), new Dialog_crops() {
...
//                        }
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (NetworkDetector.isNetworkStatusAvialable(Farmx_Addland.this)) {
                    ...
                    Toast.makeText(Farmx_Addland.this, "Please check your Internet Connection", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private boolean validatesignForm() {
        if (!(district != null && district.getText().length() > 0)) {
            ...
            return false;
        }/* else if (!(Main_Crop_list != null && Main_Crop_list.size() > 0)) {
    ...
    public void INIT() {
        ...
        ArrayAdapter<String> irrigation_adpter = new ArrayAdapter(Farmx_Addland.this, R.layout.spinner_item,
                irrigation_data);
        ...
        ArrayAdapter<String> acers_adpter = new ArrayAdapter(Farmx_Addland.this, R.layout.spinner_item,
                acers_no);
        ...
        ArrayAdapter<String> annualrevenue_adpter = new ArrayAdapter(Farmx_Addland.this, R.layout.spinner_item,
                annualrevenue_data);
        ...
        ArrayAdapter<String> soiltype_adpter = new ArrayAdapter(Farmx_Addland.this, R.layout.spinner_item,
                Soiltype_data);
...
//
        ...
        AndroidNetworking.post(Webservice.addlandfarmx)
                ...
                .addUrlEncodeFormBodyParameter("soiltype", soiltype.getSelectedItem().toString())
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                if (UserHelper.checkResponse(Farmx_Addland.this, jsonObject)){
                    return;
                }
                ...
                try {
                    if (jsonObject.optString("status").equalsIgnoreCase("true")) {
                        ...
                        Toasty.success(Farmx_Addland.this, jsonObject.optString("message"), Toast.LENGTH_SHORT, true).show();
                        finish();

                    } else {
                        Toasty.error(Farmx_Addland.this, jsonObject.optString("message"), Toast.LENGTH_SHORT, true).show();
                    }
            ...
            public void onError(ANError anError) {
                viewDialog.hideDialog();
                try {
                    Toasty.error(Farmx_Addland.this, "Add Land Error!", Toast.LENGTH_SHORT, true).show();
...
//                }
                ...
                try {
                    ...
                    if (jsonObject.optString("status").equalsIgnoreCase("true")) {
                        ...
                        ArrayAdapter<String> block_adpter = new ArrayAdapter(Farmx_Addland.this, R.layout.spinner_item,
                                b_data);
