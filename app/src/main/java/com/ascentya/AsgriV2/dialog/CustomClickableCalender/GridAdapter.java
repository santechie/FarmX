...
public class GridAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout dotContainer = view.findViewById(R.id.dotContainer);
        ...
        for (int i = 0; i < allEvents.size(); i++) {
            ...
            if (dayValue == eventCalendar.get(Calendar.DAY_OF_MONTH) && displayMonth == eventCalendar.get(Calendar.MONTH) + 1) {
                ...
                int color = (allEvents.get(i).getColor() != 0) ? allEvents.get(i).getColor() : Color.parseColor("#FF0000");

                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
                        ViewGroup.LayoutParams.WRAP_CONTENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParams.setMarginEnd(ConvertUtils.dpToPx(1f, getContext()));
