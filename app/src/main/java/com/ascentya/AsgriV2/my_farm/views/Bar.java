package com.ascentya.AsgriV2.my_farm.views;
...
public class Bar extends LinearLayout {
    ...
    public Bar(Context context, AttributeSet attrs) {
        ...
        b1TextView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.bar_green));
        b2TextView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.bar_red));
    ...
    public void updateBar(float b1, float b2) {
        ...
        Log.i("percent1", String.valueOf(percent1));
        Log.i("percent2", String.valueOf(percent2));

        b1TextView.setLayoutParams(new LayoutParams(
                LayoutParams.FILL_PARENT,
                LayoutParams.WRAP_CONTENT, percent1));

        b2TextView.setLayoutParams(new LayoutParams(
                LayoutParams.FILL_PARENT,
                LayoutParams.WRAP_CONTENT, percent2));
