package com.ascentya.AsgriV2.my_farm.transformer;
...
public class ShadowTransformer implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
   ...
   private WeatherForecastViewPagerAdapter cardAdapter;
   private float lastOffset;
   private boolean scalingEnabled;

   public ShadowTransformer(ViewPager viewPager, WeatherForecastViewPagerAdapter adapter) {
   ...
   public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
      ...
      int nextPosition;
      float baseElevation = cardAdapter.BASE_ELEVATION;
      float realOffset;
      ...
      if (currentCard != null) {
         ...
         currentCard.setCardElevation((baseElevation + baseElevation
                 * (WeatherForecastViewPagerAdapter.MAX_ELEVATION_FACTOR - 1) * (1 - realOffset)));
      }
      ...
      if (nextCard != null) {
         ...
         nextCard.setCardElevation((baseElevation + baseElevation
                 * (WeatherForecastViewPagerAdapter.MAX_ELEVATION_FACTOR - 1) * (realOffset)));
      }
