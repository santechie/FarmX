...
public class Others_Adapter extends RecyclerView.Adapter<Others_Adapter.ViewHolder> {

    private List<others_model> items = new ArrayList<>();
    private Context ctx;
    private Boolean completed_list;
    private ContractUpdate contractUpdate;

    public Others_Adapter(Context context, List<others_model> items, Boolean completed) {
        this.items = items;
        this.ctx = context;
        this.completed_list = completed;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder vh;
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.othersupdated_row, parent, false);
        vh = new ViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            view.c_name.setText(items.get(position).getTitle());
