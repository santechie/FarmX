...
public class Lang_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Lang_Model> items = new ArrayList<>();
    private Context ctx;
    Locale myLocale;
    ...
    public Lang_Adapter(Context context, List<Lang_Model> items, Dialog dialog) {
        this.items = items;
        this.ctx = context;
        this.dialog = dialog;

        lang = new Preferred_LangToken(ctx);
    }
        ...
        if (holder instanceof ViewHolder) {
            ...
            view.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    setLocale(items.get(position).getLang_id());
                }
            });
    ...
    public void setLocale(String localeName) {
        ...
        lang.setToken(localeName);

//        if (localeName.equalsIgnoreCase("ta")){
//           lang= "";
//        } else if (localeName.equalsIgnoreCase("hi")){
//            Webservice.lang_id= 2;
//
//        }else {
//            Webservice.lang_id= 0;
//
//        }
...
//            Locale locale;
            ...
            LocaleHelper.setLocale(ctx, localeName);
           ...
           /* locale = new Locale(localeName);
            ...
            Intent refresh = new Intent(ctx, Main_Dashboard.class);
            refresh.putExtra("lang", localeName);
            refresh.putExtra("state", localeName);
