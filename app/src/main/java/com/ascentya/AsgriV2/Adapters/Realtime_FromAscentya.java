...
public class Realtime_FromAscentya extends RecyclerView.Adapter<Realtime_FromAscentya.ViewHolder> {
    ...
    String Temp_url, humidity_url, soilmos_url, ph_url, sunlight_url, land_name;
    int pos = 2;


    public Realtime_FromAscentya(Context context, List<MylandMaster_Model> items, Boolean master, ViewDialog viewDialog, String pos, String cropid) {
        this.items = items;
        ctx = context;
        ...
        this.pos = Integer.parseInt(cropid);

//        Toasty.normal(context, "Adapter").show();

        System.out.println("Land Name: " + land_name);
        System.out.println("Position: " + cropid);
...
//            gethumidity(getCategoryPos("tomato"));
            ...
            add_master(land_name, holder.itemView.findViewById(R.id.updatedTime));
...
//        Toast.makeText(this, String.valueOf(Webservice.crops.indexOf(category)), Toast.LENGTH_SHORT).show();
    ...
    public void add_master(String device_name, TextView updateTimeTv) {
        Data = new ArrayList<>();
        viewDialog.showDialog();
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    if (jsonObject.optString("status").equalsIgnoreCase("true")) {
                        ...
                        System.out.println("add_master: \n"
                                +(Webservice.valuesfrommaster.replace("http", "****"))+"\n"
                        ...
                        String dateTime = jsonArray.optString("created_at");
                        String dateText = AsgriDateUtils.getDateFromTimestamp(dateTime);

                        updateTimeTv.setText("Update on: " + dateText);

                        String hum_val = jsonArray.optString("crop_humidity");
                        ...
                        String moisture_val = jsonArray.optString("crop_moisture");
                        ...
                        String light_val = jsonArray.optString("crop_dissolved_solids");
                        ...
                        String temp = jsonArray.optString("crop_temperature");
                        ...
                        String ph_val = jsonArray.optString("crop_waterph");
