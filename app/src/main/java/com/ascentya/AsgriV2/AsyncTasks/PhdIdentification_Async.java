...
public class PhdIdentification_Async extends AsyncTask<Void, Void, Void> {
    String Data;
    String id;
    Context cont;
    private AsyncTaskCompleteListener<String> callback;

    public PhdIdentification_Async(Context context, AsyncTaskCompleteListener<String> cb, String userid, String Data) {
        this.Data = Data;
        this.id = userid;
        this.cont = context;
        this.callback = cb;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        DatabaseClient
                ...
                .getAppDatabase()
                .taskDao()
                .updatephdidentification(Data, Integer.parseInt(id));
