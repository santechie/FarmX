...
public class NutrientValues_Async extends AsyncTask<Void, Void, Void> {
    ...
    public NutrientValues_Async(Context context, AsyncTaskCompleteListener<String> cb, String userid, String Data) {
        this.Data = Data;
        this.id = userid;
        this.cont = context;
        this.callback = cb;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        DatabaseClient
                ...
                .getAppDatabase()
                .taskDao()
                .updatenutrient_values(Data, Integer.parseInt(id));
