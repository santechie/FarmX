...
import com.ascentya.AsgriV2.Adapters.State_Adapter;
...
public class State_DialogMaster {

    public void dialog(Context context, List<State_Model> Data, String title) {
        ...
        State_Adapter rvAdapter = new State_Adapter(context, Data, dialog);
