...
import com.ascentya.AsgriV2.Adapters.Common_Adapter;
...
public class Dialog_Master {
    public void dialog(Context context, List<String> Data, String title) {
        ...
        Common_Adapter rvAdapter = new Common_Adapter(context, Data);
